...
func NewAccountService(accountRepository *repositories.AccountRepository, cache *rediscache.Client) *AccountService {
	return &AccountService{accountRepository: accountRepository, cache: cache}
}

func (as *AccountService) CreateAccount(ctx context.Context, account *models.Account) error {
...
func (as *AccountService) FindByID(ctx context.Context, id uint) (*models.Account, error) {
...
func (as *AccountService) FindByUsername(ctx context.Context, username string) (*models.Account, error) {
...
func (as *AccountService) FindAll(ctx context.Context) ([]*models.Account, error) {
	return as.accountRepository.FindAll(ctx)
}

func (as *AccountService) UpdateProfile(ctx context.Context, accountID uint, req *models.UpdateProfileRequest) error {
